...
import { updateProfessor } from '../services/adminService';
...
export default function EditProfessorScreen() {
  ...
  const { professor } = route.params as { professor: Professor };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await updateProfessor(token, professor._id, updateData);
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.title}>
          Editar <Text style={{ color: '#222' }}>Professor</Text>
        </Text>
        ...
        <View style={styles.infoContainer}>
          <Text style={styles.infoText}>
            Professor criado em: {new Date(professor.createdAt).toLocaleDateString('pt-BR')}
          </Text>
          <Text style={styles.infoText}>
            Última atualização: {new Date(professor.updatedAt).toLocaleDateString('pt-BR')}
          </Text>
        </View>
      </View>
    </ScrollView>
